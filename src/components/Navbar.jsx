            ...
            <header
                ...
                <div className="container">
                    <div className={"relative flex items-center justify-between py-3"}>
                        ...
                        <div
                            className={`hidden lg:block lg:w-4/6`}>
                            <nav>
                                <ul
                            ...
                            <ul className="flex items-center justify-end text-white gap-2 lg:gap-3">
                                <li>
                                    <button
                                        ...
                                        className={"hidden lg:block text-2xl lg:text-3xl transition ease-linear duration-500 hover:text-[#E50000]"}
                                    >
                                        <Search/>
                                    </button>
                                </li>
                                ...
                                <li className={`relative hidden group lg:block text-white has-[.active]:text-[#E50000]`}>
                                    <NavLink
                ...
                <div className={`w-full fixed bottom-0 left-0 z-30 text-white`}>
                    <nav>
                        <ul className={`flex justify-between items-center bg-[#262626]`}>
                            <li>
                                <NavLink
                                    to={`/`}
